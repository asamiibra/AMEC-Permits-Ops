...
for user in proposalops_rw proposalops_ro proposalops_denied owner_test bd_test engineering_test; do
...
mkdir -p "/srv/shares/Services Provider" /srv/shares/ProposalOpsLab/proposalops /srv/shares/Marketing /srv/shares/pro /srv/shares/Tenders /srv/shares/Supervision

...
- `backend/app/services/proposal_source_workspace.py`
- `backend/app/api/proposal_source_routers.py`
- `backend/tests/test_proposal_source_workspace.py`
- `frontend/src/ProposalSourceWorkspace.tsx`
- `mock-systems/proposal-sources/` (deterministic source fixture)

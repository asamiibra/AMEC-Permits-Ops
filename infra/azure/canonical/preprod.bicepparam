...
param bridgePackageSigningPublicKey = readEnvironmentVariable('PROPOSALOPS_PREPROD_BRIDGE_PACKAGE_SIGNING_PUBLIC_KEY', 'REQUIRED_AT_DEPLOYMENT')
param bridgeAllowedSourceIdentities = 'QATAR_SYNOLOGY_SYNTHETIC_FIXTURE'
param bridgeAllowedSourcePathPrefixes = 'synthetic://qatar-synology/'

...
param bridgePackageSigningPublicKey = readEnvironmentVariable('PROPOSALOPS_PRODUCTION_BRIDGE_PACKAGE_SIGNING_PUBLIC_KEY', 'REQUIRED_AT_DEPLOYMENT')
param bridgeAllowedSourceIdentities = 'QATAR_SYNOLOGY_LIVE'
param bridgeAllowedSourcePathPrefixes = 'synology://qatar/Tenders/1- Proposal/2026/'

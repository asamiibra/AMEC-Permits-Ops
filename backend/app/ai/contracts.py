...
class AIPurpose(str, Enum):
    ...
    PROPOSAL_TENDER_INTAKE_ANALYSIS = "PROPOSAL_TENDER_INTAKE_ANALYSIS"
    PROPOSAL_REQUIREMENT_EVIDENCE_ANALYSIS = "PROPOSAL_REQUIREMENT_EVIDENCE_ANALYSIS"
    PROPOSAL_SECTION_DRAFT = "PROPOSAL_SECTION_DRAFT"
    PROPOSAL_COMMERCIAL_CONSISTENCY_REVIEW = "PROPOSAL_COMMERCIAL_CONSISTENCY_REVIEW"
    PROPOSAL_LPO_VARIANCE_ANALYSIS = "PROPOSAL_LPO_VARIANCE_ANALYSIS"
    PROPOSAL_HANDOFF_PREFLIGHT = "PROPOSAL_HANDOFF_PREFLIGHT"
    PROPOSAL_DOCUMENT_CHANGE_PLAN = "PROPOSAL_DOCUMENT_CHANGE_PLAN"
    MASTER_CONTENT_INTELLIGENCE = "MASTER_CONTENT_INTELLIGENCE"

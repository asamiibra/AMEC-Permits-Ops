...
def finalize_success(db: Session, *, ledger_id: str, correlation_id: str, actor_id: str | None, actor_type: str, usage: AIProviderUsage, estimated_cost: float, output_fingerprint: str, citation_count: int, provider_response_id: str, actual_model: str | None = None, actual_version: str | None = None, access_mode: str | None = None, latency_ms: int | None = None) -> None:
    ...
    audit(db, correlation_id=correlation_id, event_type="AI_INTERACTIVE_REQUEST_SUCCEEDED", entity_type="AIExecutionLedger", entity_id=ledger.id, actor_id=actor_id, actor_type=actor_type, metadata={"ledger_id": ledger.id, "input_tokens": usage.input_tokens, "output_tokens": usage.output_tokens, "total_tokens": usage.total_tokens, "estimated_cost_usd": estimated_cost, "citation_count": citation_count, "output_fingerprint": output_fingerprint, "actual_model": actual_model, "actual_version": actual_version, "access_mode": access_mode, "latency_ms": latency_ms})

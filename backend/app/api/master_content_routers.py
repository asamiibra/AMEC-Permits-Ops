...
from ..services.master_content import (
    ...
    canonical_form_discovery_catalogs,
...
from ..services.dashboard_v2_governance import require_reader
...
@router.get("/master-content/catalogs")
def discovery_catalogs(db: Session = Depends(get_db), role: Role = Depends(current_user_role)):
    require_reader(role)
    return canonical_form_discovery_catalogs(db)

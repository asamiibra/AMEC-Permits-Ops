...
# Preserve the existing contract capability aliases while retaining main's
# consolidated authority capability and the Content Library dependency seam.
for _persona in ("SYSTEM_ADMIN", "OWNER"):
    CAPABILITY_MATRIX[_persona].update({
        "CONTRACT_REVIEW_AUTHORITY",
        "CONTRACT_ACCEPT_AUTHORITY",
        "CONTRACT_EXECUTION_EVIDENCE",
        "CONTRACT_HANDOFF",
        "MASTER_CONTENT_RECONCILE",
    })
...
CAPABILITY_MATRIX["SYSTEM_ADMIN"].update({
    "PHASE4_SOURCE_REVIEW", "PHASE4_REVIEW_QUEUE", "PHASE4_REVIEW_DECISION",
    "PHASE4_PROMOTE_VERIFIED_ASSERTION", "PHASE4_TYPED_PROJECTION",
    "PHASE4_VIEW_SOURCE_REVIEW", "PHASE4_RESOLVE_RELATIONSHIP", "PHASE4_VIEW_RESTRICTED_EVIDENCE",
})
CAPABILITY_MATRIX["OWNER"].update({
    "PHASE4_SOURCE_REVIEW", "PHASE4_REVIEW_QUEUE", "PHASE4_REVIEW_DECISION",
    "PHASE4_PROMOTE_VERIFIED_ASSERTION", "PHASE4_TYPED_PROJECTION",
    "PHASE4_VIEW_SOURCE_REVIEW", "PHASE4_RESOLVE_RELATIONSHIP", "PHASE4_VIEW_RESTRICTED_EVIDENCE",
})
CAPABILITY_MATRIX["BUSINESS_DEVELOPMENT"].update({
    "PHASE4_SOURCE_REVIEW", "PHASE4_REVIEW_QUEUE", "PHASE4_REVIEW_DECISION",
    "PHASE4_VIEW_SOURCE_REVIEW", "PHASE4_RESOLVE_RELATIONSHIP",
})
CAPABILITY_MATRIX["ENGINEERING"].update({
    "PHASE4_SOURCE_REVIEW", "PHASE4_REVIEW_QUEUE", "PHASE4_REVIEW_DECISION",
    "PHASE4_TYPED_PROJECTION",
    "PHASE4_VIEW_SOURCE_REVIEW", "PHASE4_RESOLVE_RELATIONSHIP",
})

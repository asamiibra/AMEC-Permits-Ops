...
CAPABILITY_MATRIX = {
    "SYSTEM_ADMIN": {"READ_ALL", "PROMOTE_SOR", "PROCEED", "CREATE_CONTRACT", "INITIATE_PERMIT", "INTAKE", "EDIT_COMMERCIAL", "EDIT_TECHNICAL", "PROPOSAL_PREPARATION", "ENGINEERING_READY", "PERMIT_TECHNICAL", "MASTER_FORM_WRITE", "MASTER_REPORT_WRITE", "MASTER_ENGINEERING_WRITE", "DEFINITION_WRITE", "MASTER_CONTENT_ARCHIVE", "MASTER_CONTENT_BINDING_WRITE"},
    "OWNER": {"READ_ALL", "PROMOTE_SOR", "PROCEED", "CREATE_CONTRACT", "INITIATE_PERMIT", "INTAKE", "EDIT_COMMERCIAL", "EDIT_TECHNICAL", "PROPOSAL_PREPARATION", "ENGINEERING_READY", "PERMIT_TECHNICAL", "MASTER_FORM_WRITE", "MASTER_REPORT_WRITE", "MASTER_ENGINEERING_WRITE", "DEFINITION_WRITE", "MASTER_CONTENT_ARCHIVE", "MASTER_CONTENT_BINDING_WRITE"},
    "BUSINESS_DEVELOPMENT": {
        "READ_ALL", "INTAKE", "EDIT_COMMERCIAL", "PROCEED", "CREATE_CONTRACT", "INITIATE_PERMIT",
    },
    "ENGINEERING": {
        "READ_ALL", "EDIT_TECHNICAL", "PROPOSAL_PREPARATION", "ENGINEERING_READY", "PERMIT_TECHNICAL",
    },
}

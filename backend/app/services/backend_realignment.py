...
CAPABILITY_MATRIX = {
    ...
    "ENGINEERING": {
        "READ_ALL", "EDIT_TECHNICAL", "PROPOSAL_PREPARATION", "ENGINEERING_READY", "PERMIT_TECHNICAL", "BD_PROPOSAL_READ", "CONTRACT_READ", "ENGINEERING_PROJECT_READ", "ENGINEERING_PROJECT_EDIT", "ENGINEERING_REVIEW", "ENGINEERING_PROFESSIONAL_APPROVE", "ENGINEERING_BASELINE_APPROVE",
    },
}

...
CAPABILITY_MATRIX = {
    "SYSTEM_ADMIN": {"READ_ALL", "PROMOTE_SOR", "PROCEED", "CREATE_CONTRACT", "INITIATE_PERMIT", "INTAKE", "EDIT_COMMERCIAL", "EDIT_TECHNICAL", "PROPOSAL_PREPARATION", "ENGINEERING_READY", "PERMIT_TECHNICAL", "MASTER_FORM_WRITE", "MASTER_REPORT_WRITE", "MASTER_ENGINEERING_WRITE", "DEFINITION_WRITE", "MASTER_CONTENT_ARCHIVE", "MASTER_CONTENT_BINDING_WRITE", "MASTER_CATEGORY_WRITE", "BD_PROPOSAL_READ", "BD_PROPOSAL_WRITE", "BD_PROPOSAL_ACCEPT", "BD_PROPOSAL_HANDOFF", "BD_PROPOSAL_OWNER_SETTINGS"},
    ...
    "BUSINESS_DEVELOPMENT": {
        "READ_ALL", "INTAKE", "EDIT_COMMERCIAL", "PROCEED", "CREATE_CONTRACT", "INITIATE_PERMIT", "BD_PROPOSAL_READ", "BD_PROPOSAL_WRITE", "BD_PROPOSAL_ACCEPT", "BD_PROPOSAL_HANDOFF", "BD_PROPOSAL_OWNER_SETTINGS",
    },
    "ENGINEERING": {
        "READ_ALL", "EDIT_TECHNICAL", "PROPOSAL_PREPARATION", "ENGINEERING_READY", "PERMIT_TECHNICAL", "BD_PROPOSAL_READ",
    },
}

...
def snapshot_for_accept(db: Session, proposal: Opportunity, validation: dict[str, Any]) -> dict[str, Any]:
    ...
    from .proposal_final_hardening import hardening_projection, material_fingerprint, master_content_fingerprint
    ...
    return {
        ...
        "master_content_fingerprint": master_content_fingerprint(db),

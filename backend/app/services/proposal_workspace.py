...
def proposal_projection(db: Session, proposal: Opportunity) -> dict[str, Any]:
    ...
    return {
        ...
        "draft_revision": {"id": draft_revision.id, "revision_number": draft_revision.revision_number, "base_accepted_revision_id": draft_revision.base_accepted_revision_id, "content_hash": draft_revision.content_hash, "change_summary": draft_revision.change_summary, "snapshot": draft_revision.snapshot} if draft_revision else None,

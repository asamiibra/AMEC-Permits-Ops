...
def upgrade() -> None:
    ...
    op.create_index("ix_physical_original_evidence_document_version_id", "physical_original_custody_events", ["evidence_document_version_id"])


def downgrade() -> None:
    for name in (
        "ix_physical_original_evidence_document_version_id",

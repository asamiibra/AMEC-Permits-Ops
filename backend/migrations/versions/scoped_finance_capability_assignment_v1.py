...
def upgrade() -> None:
    ...
    op.create_index("ix_scoped_capability_assignments_user_id", "scoped_capability_assignments", ["user_id"])
    op.create_index("ix_scoped_capability_assignments_user_capability", "scoped_capability_assignments", ["user_id", "capability_code"])
    op.create_index("ix_scoped_capability_assignments_project_status", "scoped_capability_assignments", ["project_id", "status"])
    op.create_index("ix_scoped_capability_assignments_client_status", "scoped_capability_assignments", ["client_account_id", "status"])
    op.create_index("ix_scoped_capability_assignments_office_id", "scoped_capability_assignments", ["office_id"])

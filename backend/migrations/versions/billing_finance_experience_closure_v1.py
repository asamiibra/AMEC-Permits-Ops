...
def upgrade() -> None:
    ...
    op.create_index("ix_billing_fx_rate_records_source_currency", "billing_fx_rate_records", ["source_currency"])
    op.create_index("ix_billing_fx_rate_records_status", "billing_fx_rate_records", ["status"])
    op.create_table(
    ...
    op.create_index("ix_project_expected_exp_versions_project_id", "project_expected_exp_versions", ["project_id"])
    op.create_index("ix_project_expected_exp_versions_status", "project_expected_exp_versions", ["status"])

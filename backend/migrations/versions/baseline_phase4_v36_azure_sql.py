...
def upgrade() -> None:
    ...
    bind = op.get_bind()
    # PostgreSQL cannot infer one type for a bind reused in both the SELECT
    # projection and the NOT EXISTS predicate. Explicit casts keep the
    # zero-to-head migration portable without changing the control row.

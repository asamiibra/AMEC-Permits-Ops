...
def upgrade() -> None:
    ...
    bind = op.get_bind()
    bind.execute(sa.text("INSERT INTO master_content_reference_sequences (active, content_type, created_at, current_value, id, padding, prefix, scope, updated_at) VALUES (:value_0, :value_1, CURRENT_TIMESTAMP, :value_3, :value_4, :value_5, :value_6, :value_7, CURRENT_TIMESTAMP) ON CONFLICT DO NOTHING"),
    ...
    # Control data source: legacy revision 0055_bd_proposal_final_hardening.

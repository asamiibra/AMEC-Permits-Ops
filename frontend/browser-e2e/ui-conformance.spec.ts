...
async function fulfillApi(route: any) {
  ...
  else if (pathName === "/api/master-content") body = [{ id: "form-1", ref: "SYN-FRM-0001", content_type: "FORM", title: "Synthetic canonical form", description: "Synthetic canonical form", used_in: ["ADMIN"], version: 1, version_status: "CURRENT", owner_status: "Current", current_source_filename: "synthetic-form.pdf", category: { id: "cat-1", label: "Forms" } }];
  else if (pathName === "/api/master-content/categories") body = [{ id: "cat-1", label: "Forms", allowed_content_types: ["FORM"] }];
  ...
  else if (pathName === "/api/monitoring/policies") body = { policies: [] , production_read_approved: false };

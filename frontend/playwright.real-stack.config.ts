...
export default defineConfig({
  ...
  reporter: [["list"], ["json", { outputFile: process.env.PLAYWRIGHT_JSON_OUTPUT_FILE || "test-results/real-stack-playwright.json" }]],
  globalTeardown: "./browser-real-stack/global-teardown.ts",
});

...
export function AMECWorkPage({ openAbout }: { openAbout?: () => void }) {
  ...
  return <div className="workflow-page amec-work-page">
    ...
    <section className="dashboard-destination-grid" aria-label="Dashboards">
      ...
      {isOwner && <a className="dashboard-destination-card dashboard-destination-v2" href="/dashboard-v2"><span className="eyebrow">MASTER CONTENT · NEW</span><h3>Dashboard V2 <span className="tag">NEW</span></h3><p>Wave A governed master content, readiness, provenance, and source controls.</p><span className="button-secondary">Open Dashboard V2 →</span></a>}
    </section>

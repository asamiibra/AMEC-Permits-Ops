...
export function AMECWorkPage({ openAbout }: { openAbout?: () => void }) {
  ...
  return <div className="workflow-page amec-work-page">
    ...
    <section className="dashboard-destination-grid" aria-label="Dashboards">
      <a className="dashboard-destination-card" href="/dashboard"><span className="eyebrow">MASTER CONTENT</span><h3>Dashboard</h3><p>Existing Forms, Reports, Engineering Works, and Definitions workspace.</p><span className="button-secondary">Open Dashboard <Icon name="arrow-up-right" size={14} /></span></a>
    </section>

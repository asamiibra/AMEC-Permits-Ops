...
export function Week10Page() {
  ...
  return <>
    ...
    <div className="two-col">
      ...
      <section className="panel"><div className="panel-head"><div><span className="eyebrow">FINDING CLOSURE</span><h3>Evidence-backed lifecycle</h3></div><span className="tag warning">RBAC</span></div><p>Correction → evidence → configured verifier → verified closure. Task completion never closes a Finding.</p><div className="journey">OPEN → CORRECTION_MADE → EVIDENCE_ATTACHED → VERIFIED → CLOSED_VERIFIED</div><p className="muted">Disputes satisfy the gate only when the FindingCode explicitly allows formal dispute.</p></section>
    </div>
